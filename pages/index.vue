          ...
          <a href="#" class="logo-link">
            <div class="logo-container">
              ...
              <div class="logo-text-container">
                <h1 class="logo-text">
                  一键<span class="logo-text-highlight">大厨</span>
                </h1>
              </div>
            </div>
          </a>
        ...
        <section id="hero" class="section hero-section" data-section="hero">
          ...
          <div class="container">
            <div class="hero-content">
              <h2 class="hero-title gradient-text gsap-title">
                一键大厨 - 轻松学做美食
              </h2>
              <p
                class="hero-description gsap-desc typing-effect"
                ref="typeText"
              ></p>
        ...
        <div class="footer-content">
          <div class="footer-links">
            <span class="copyright"
              >Copyright © 2025 北京位元律动科技有限公司</span
            >
            <!-- 备案号 -->
...
.section.active .value-item:nth-child(1) {
  transition-delay: 0.25s;
}
.section.active .value-item:nth-child(2) {
  transition-delay: 0.3s;
}
.section.active .value-item:nth-child(3) {
  transition-delay: 0.35s;
}
.section.active .value-item:nth-child(4) {
...
.kitchen-utensil {
  ...
  filter: drop-shadow(0 0 5px rgba(234, 62, 64, 0.2)) invert(30%) sepia(20%)
    saturate(800%) hue-rotate(325deg) brightness(95%);
...
@keyframes floatUtensil {
  ...
  50% {
    ...
    filter: drop-shadow(0 0 8px rgba(234, 62, 64, 0.3)) invert(30%) sepia(20%)
      saturate(900%) hue-rotate(325deg) brightness(100%);
  }
}
...
.shape1 {
  ...
  background: radial-gradient(
    circle,
    rgba(234, 62, 64, 0.2) 0%,
    rgba(234, 62, 64, 0.05) 50%,
    rgba(234, 62, 64, 0) 70%
  );
  top: -150px;
  left: -100px;
...
.shape2 {
  ...
  background: radial-gradient(
    circle,
    rgba(255, 186, 90, 0.2) 0%,
    rgba(255, 186, 90, 0.05) 50%,
    rgba(255, 186, 90, 0) 70%
  );
  bottom: -200px;
  right: -150px;
  animation-delay: 5s;
